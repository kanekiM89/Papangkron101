        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('u.index') }}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>User</a>
                    <a href="{{ route('c.index') }}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Category</a>
                    <a href="{{ route('p.index') }}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Product</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
